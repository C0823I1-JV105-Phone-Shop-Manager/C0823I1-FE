  ...
  return (
    ...
    <div className="card w-75 mb-3 mx-auto shadow">
        ...
        <Form className=" card-body ">
            <div className="row px-5">
                ...
                <div className="col">
                    <button className="form-control btn btn-secondary col fw-bold">Quét mã QR</button>
                </div>
            </div>
    ...
    <div className="card w-75 mb-3 mx-auto shadow">
        ...
        <form className="card-body w-100 mx-auto mb-3 ">
            ...
            <div className="row px-5">
                <div className="col-5">
                    <button className="btn btn-secondary form-control fw-bold">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
            ...
            <div className="row g-2 mt-3 px-5">
                <div className="col">
                    <div className="row mb-3">
                        <label for="product-name" className="form-label col-3 fw-bold">Tên sản phẩm</label>
                        <div className="col-9">
                            <input type="text" className="form-control form-control-sm" id="product-name"/>
                        </div>
                    </div>
                    <div className="row mb-3">
                        <label for="price" className="form-label col-3 fw-bold">Đơn giá</label>
                        <div className="col-9">
                            <input type="text" className="form-control form-control-sm" id="price"/>
                        </div>
                    </div>
                    <div className="row mb-3">
                        <label for="quantity" className="form-label col-3 fw-bold">Số lượng</label>
                        <div className="col-9">
                            <input type="text" className="form-control form-control-sm" id="quantity"/>
                        </div>
                    </div>
            ...
            <div className="row px-5">
                <div className="col">
                    <button className="btn btn-info form-control fw-bold">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
        ...
        <form className="card-body">
            ...
            <table className="table">
                ...
                <tr>
                    ...
                    /></td>
                    <td>
                        <span for="product-name" className="form-label col-5">Iphone 15</span>
                    </td>
                    <td>
                        <input type="number" name="price" className="form-control form-control-sm"/>
                    </td>
                    <td>
                        <input type="number" name="quantity" className="form-control form-control-sm"/>
                    </td>
                    <td>
                        <input type="number" name="total" className="form-control form-control-sm"/>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    /></td>
                    <td>
                        <span for="product-name" className="form-label col-5">Samsung S24</span>
                    </td>
                    <td>
                        <input type="number" name="price" className="form-control form-control-sm"/>
                    </td>
                  ...
                  >
                              <Form className="row g-3 mb-3">
                                  <div className="col-md-2 col-12 ">
                                      <label htmlFor="search-field" className="form-label fw-bold">Tìm kiếm theo</label>
                                  </div>

                                  <div className="col-md-4 col-12">
                                      <Field name='name' className="form-control" placeholder="Nhập ..."/>
                                  </div>
                                  <div className="col-md-3 col-12">
                                      <button type='submit' className="btn btn-outline-info">Tìm kiếm</button>
                                  </div>
                              </Form>
                  </Formik>
                  {/*<Formik*/}
