                ...
                <nav className="navbar navbar-expand bg-white shadow mb-4 topbar">
                    <div className="container-fluid">
                        <ul className="navbar-nav flex-nowrap ms-auto">
                            ...
                            <li className="nav-item dropdown no-arrow" style={{ height: '105.6px' }}><span className="d-none d-lg-inline me-2 text-gray-600 small"><br />Xin chào , {profileInfo.username}</span><img className="border rounded-circle img-profile" src={usernameAva} /></li>
                        </ul>
                    </div>
                </nav>
    );
